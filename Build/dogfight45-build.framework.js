...
var ASM_CONSTS = {
  4472796: () => { Module['emscripten_get_now_backup'] = performance.now; },  
 4472851: ($0) => { performance.now = function() { return $0; }; },  
 4472899: ($0) => { performance.now = function() { return $0; }; },  
 4472947: () => { performance.now = Module['emscripten_get_now_backup']; }
};
